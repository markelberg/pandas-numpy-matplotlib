...
axs[0].set_xlabel('Especie', color='blue', fontweight='bold', fontsize=13)
axs[0].xaxis.set_label_coords(0.5, -1)
axs[0].set_ylabel('Capacidad Craneal (m\u00B3)', color='blue', fontweight='bold', fontsize=13)
axs[0].set_title('Especies de homínidos con mayor capacidad craneal', fontweight='bold', fontsize=18)
...
axs[1].set_xlabel('Millones de años', color='blue', fontweight='bold', fontsize=13)
axs[1].set_ylabel('Localización', color='blue', fontweight='bold', fontsize=13)
axs[1].set_title('Dispersión de Especies por Tiempo y Localización', fontweight='bold', fontsize=18)
